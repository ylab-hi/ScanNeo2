...
_executable_filename = \
    pkg_resources.resource_filename('netmhciipan_3_2_executable', 'netMHCIIpan')
...
def single_prediction(sequence_list, allele_length_2tuple_list, delete_tempfiles=False):
...
def get_allele_name_scores_from_netmhciipan_output(netmhciipan_output):
