...
_executable_filename = \
    pkg_resources.resource_filename('netmhciipan_4_3_executable', 'netMHCIIpan')
    ...
    try:
        ...
        for allele_name, binding_length in allele_length_2tuple_list:
            if is_user_defined_allele(allele_name):
                ...
                elif not allele_name.startswith("DRB") and not allele_name.startswith('BoLA'):
